...
local function SetBorder(self, width, r, g, b, a)
  Library.LibSimpleWidgetsLifeEdition.SetBorder(self.scroller, width, r, g, b, a)
end
...
function Library.LibSimpleWidgetsLifeEdition.TextArea(name, parent)
  local widget = UI.CreateFrame("Frame", name, parent)
  widget.scroller = UI.CreateFrame("SimpleLifeScrollView", name.."ScrollView", widget)
  widget.textarea = UI.CreateFrame("RiftTextfield", name.."TextArea", widget)
  widget.blocker = UI.CreateFrame("Frame", name.."Blocker", parent)

  widget.scroller:SetBackgroundColor(0.07, 0.07, 0.07, 0.85)
  widget.scroller:SetAlpha(0.85)
  --widget.textarea:SetBackgroundColor(0.07, 0.07, 0.07, 0.85)
 -- widget.textarea:SetAlpha(0.85)
  widget.scroller:SetAllPoints(widget)
  widget.scroller:SetContent(widget.textarea)

  widget.blocker:SetAllPoints(widget)
  --widget.blocker:SetBackgroundColor(0.07, 0.07, 0.07, 0.85)
  ...
  Library.LibSimpleWidgetsLifeEdition.EventProxy(widget, {"TextAreaChange","TextAreaSelect"})
