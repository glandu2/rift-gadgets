...
function jnhOrb:Construct(options)
	...
	-- MP ORB =====================================================================================
			-- ORB back BG
			{
				...
				visibilityBinding="id", texAddon = AddonId, texFile = "img/jnhOrb2_back.png"		
			}, 
			...
			-- ORB filling BG
			{
				...
				}, visibilityBinding="id", binding="resourcePercent", growthDirection="up",
				media="jnhOrb2_BLEU", 
			...
			-- ORB ring on top
			{
				...
				visibilityBinding="id", texAddon = AddonId, texFile = "img/jnhOrb2_ring.png"		
			},
	...
	-- LVL + NAME =====================================================================================
			{
				...
				attach = 
				{ 
					{ point="BOTTOMRIGHT", element="frame", targetPoint="BOTTOMRIGHT", offsetX=-45, offsetY=5 },
				}, visibilityBinding="id", text="{nameShort} - ",fontSize=22, outline=true
			},
			{
				id="TxtLvl", type="Label", parent="frame", layer=20,
				attach = 
				{ 
					{ point="BOTTOMRIGHT", element="frame", targetPoint="BOTTOMRIGHT", offsetX=-10, offsetY=5 },
				}, visibilityBinding="id", text="{level}",fontSize=26, outline=true
			},
		}
	}
