...
local function SetBorder(self, width, r, g, b, a)
  Library.LibSimpleWidgetsLifeEdition.SetBorder(self.current, width, r, g, b, a)
  Library.LibSimpleWidgetsLifeEdition.SetBorder(self.editor, width, r, g, b, a)
  Library.LibSimpleWidgetsLifeEdition.SetBorder(self.dropdown, width, r, g, b, a)
end
...
local function SetEditable(self, editable)
  ...
  if editable then
    if not self.editor then
      ...
      Library.LibSimpleWidgetsLifeEdition.SetBorder(self.editor, 1, 0.5, 0.5, 0.5, 1)
...
function Library.LibSimpleWidgetsLifeEdition.Slider(name, parent)
  ...
  Library.LibSimpleWidgetsLifeEdition.SetBorder(widget.current, 1, 0.5, 0.5, 0.5, 1)
  ...
  Library.LibSimpleWidgetsLifeEdition.EventProxy(widget, {"SliderChange","SliderGrab","SliderRelease"})
