LibSimpleWidgetsLifeEdition is a library which provides a set of simple widgets not provided by the official Rift API. It integrates into the UI.CreateFrame function, adding several new frame types:
...
**Library.LibSimpleWidgetsLifeEdition.RadioButtonGroup(name)**  
...
**Library.LibSimpleWidgetsLifeEdition.Layout(configTable, parent)**  
...
**Library.LibSimpleWidgetsLifeEdition.SetBorder(type, frame, ...)**  
...
------
    ...
    Library.LibSimpleWidgetsLifeEdition.Layout(configTable, SWT_Window:GetContent())
...
----------------
    ...
    local radioButtonGroup = Library.LibSimpleWidgetsLifeEdition.RadioButtonGroup("MyRadioButtonGroup")
